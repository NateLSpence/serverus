...
<ul id="bbp-topic-<?php bbp_topic_id(); ?>" <?php bbp_topic_class(); ?>>
	...
	<li class="bbp-topic-freshness">
			...
			<span class="bbp-topic-freshness-author"><?php bbp_author_link( array( 'post_id' => bbp_get_topic_last_active_id(), 'size' => 32, 'type' => 'avatar' ) ); ?></span>
		...
		<?php 
			...
			if ( !empty( $time_since ) )
				$anchor = '<p class="bbp-topic-freshness-text">' . esc_html( $time_since ) . '</p>';
			else
				$anchor = '<p class="bbp-topic-freshness-text">No Replies</p>';

			echo apply_filters( 'bbp_get_topic_freshness_link', $anchor, $topic_id, $time_since );
		?>


		<?php do_action( 'bbp_theme_after_topic_freshness_link' ); ?>

		<p class="bbp-topic-meta bbp-topic-freshness-text">
